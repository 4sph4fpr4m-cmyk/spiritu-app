...
const NO_FIXED = {
  ...
  "1-3":  { name: "The Most Holy Name of Jesus", rank: "optional_memorial", color: "white" },
  "1-4":  { name: "St. Elizabeth Ann Seton", rank: "memorial", color: "white" },
  "1-5":  { name: "St. John Neumann", rank: "memorial", color: "white" },
  "1-7":  { name: "St. Raymond of Penyafort", rank: "optional_memorial", color: "white" },
  "1-13": { name: "St. Hilary of Poitiers", rank: "optional_memorial", color: "white" },
  "1-17": { name: "St. Anthony of Egypt", rank: "memorial", color: "white" },
  "1-20": { name: "St. Fabian and St. Sebastian", rank: "optional_memorial", color: "red" },
  "1-21": { name: "St. Agnes", rank: "memorial", color: "red" },
  "1-22": { name: "St. Vincent, Deacon and Martyr", rank: "optional_memorial", color: "red" },
  ...
  "1-27": { name: "St. Angela Merici", rank: "optional_memorial", color: "white" },
  ...
  "2-3":  { name: "St. Blase and St. Ansgar", rank: "optional_memorial", color: "red" },
  "2-5":  { name: "St. Agatha", rank: "memorial", color: "red" },
  "2-6":  { name: "Sts. Paul Miki and Companions", rank: "memorial", color: "red" },
  "2-8":  { name: "St. Jerome Emiliani and St. Josephine Bakhita", rank: "optional_memorial", color: "white" },
  "2-10": { name: "St. Scholastica", rank: "memorial", color: "white" },
  "2-11": { name: "Our Lady of Lourdes", rank: "optional_memorial", color: "white" },
  "2-14": { name: "Sts. Cyril and Methodius", rank: "memorial", color: "white" },
  "2-17": { name: "Seven Holy Founders of the Servite Order", rank: "optional_memorial", color: "white" },
  "2-21": { name: "St. Peter Damian", rank: "optional_memorial", color: "white" },
  "2-22": { name: "Chair of St. Peter", rank: "feast", color: "white" },
  "2-23": { name: "St. Polycarp", rank: "memorial", color: "red" },
  "2-27": { name: "St. Gregory of Narek", rank: "optional_memorial", color: "white" },
  // MARCH
  "3-4":  { name: "St. Casimir", rank: "optional_memorial", color: "white" },
  "3-7":  { name: "Sts. Perpetua and Felicity", rank: "memorial", color: "red" },
  "3-8":  { name: "St. John of God", rank: "optional_memorial", color: "white" },
  "3-9":  { name: "St. Frances of Rome", rank: "optional_memorial", color: "white" },
  "3-17": { name: "St. Patrick", rank: "optional_memorial", color: "white" },
  "3-18": { name: "St. Cyril of Jerusalem", rank: "optional_memorial", color: "white" },
  "3-19": { name: "St. Joseph, Spouse of the Blessed Virgin Mary", rank: "solemnity", color: "white" },
  "3-23": { name: "St. Turibius of Mogrovejo", rank: "optional_memorial", color: "white" },
  "3-25": { name: "Annunciation of the Lord", rank: "solemnity", color: "white" },
  // APRIL
  "4-2":  { name: "St. Francis of Paola", rank: "optional_memorial", color: "white" },
  "4-4":  { name: "St. Isidore of Seville", rank: "optional_memorial", color: "white" },
  "4-5":  { name: "St. Vincent Ferrer", rank: "optional_memorial", color: "white" },
  "4-7":  { name: "St. John Baptist de la Salle", rank: "memorial", color: "white" },
  "4-11": { name: "St. Stanislaus", rank: "memorial", color: "red" },
  "4-13": { name: "St. Martin I", rank: "optional_memorial", color: "red" },
  "4-21": { name: "St. Anselm of Canterbury", rank: "optional_memorial", color: "white" },
  "4-23": { name: "St. George and St. Adalbert", rank: "optional_memorial", color: "red" },
  "4-24": { name: "St. Fidelis of Sigmaringen", rank: "optional_memorial", color: "red" },
  "4-25": { name: "St. Mark the Evangelist", rank: "feast", color: "red" },
  "4-28": { name: "St. Peter Chanel and St. Louis de Montfort", rank: "optional_memorial", color: "red" },
  "4-29": { name: "St. Catherine of Siena", rank: "memorial", color: "white" },
  "4-30": { name: "St. Pius V", rank: "optional_memorial", color: "white" },
  // MAY
  "5-1":  { name: "St. Joseph the Worker", rank: "optional_memorial", color: "white" },
  "5-2":  { name: "St. Athanasius", rank: "memorial", color: "white" },
  "5-3":  { name: "Sts. Philip and James, Apostles", rank: "feast", color: "red" },
  "5-12": { name: "Sts. Nereus and Achilleus, and St. Pancras", rank: "optional_memorial", color: "red" },
  "5-13": { name: "Our Lady of Fatima", rank: "optional_memorial", color: "white" },
  "5-14": { name: "St. Matthias the Apostle", rank: "feast", color: "red" },
  "5-18": { name: "St. John I", rank: "optional_memorial", color: "red" },
  "5-20": { name: "St. Bernardine of Siena", rank: "optional_memorial", color: "white" },
  "5-21": { name: "St. Christopher Magallanes and Companions", rank: "optional_memorial", color: "red" },
  "5-22": { name: "St. Rita of Cascia", rank: "optional_memorial", color: "white" },
  "5-25": { name: "St. Bede the Venerable, St. Gregory VII, St. Mary Magdalene de Pazzi", rank: "optional_memorial", color: "white" },
  "5-26": { name: "St. Philip Neri", rank: "memorial", color: "white" },
  "5-27": { name: "St. Augustine of Canterbury", rank: "optional_memorial", color: "white" },
  "5-29": { name: "St. Paul VI", rank: "optional_memorial", color: "white" },
  "5-31": { name: "Visitation of the Blessed Virgin Mary", rank: "feast", color: "white" },
  // JUNE
  "6-1":  { name: "St. Justin Martyr", rank: "memorial", color: "red" },
  "6-2":  { name: "Sts. Marcellinus and Peter", rank: "optional_memorial", color: "red" },
  "6-3":  { name: "Sts. Charles Lwanga and Companions", rank: "memorial", color: "red" },
  "6-5":  { name: "St. Boniface", rank: "memorial", color: "red" },
  "6-6":  { name: "St. Norbert", rank: "optional_memorial", color: "white" },
  "6-9":  { name: "St. Ephrem", rank: "optional_memorial", color: "white" },
  "6-11": { name: "St. Barnabas", rank: "memorial", color: "red" },
  "6-13": { name: "St. Anthony of Padua", rank: "memorial", color: "white" },
  "6-19": { name: "St. Romuald", rank: "optional_memorial", color: "white" },
  "6-21": { name: "St. Aloysius Gonzaga", rank: "memorial", color: "white" },
  "6-22": { name: "St. Paulinus of Nola, Sts. John Fisher and Thomas More", rank: "optional_memorial", color: "white" },
  "6-24": { name: "Birth of St. John the Baptist", rank: "solemnity", color: "white" },
  "6-27": { name: "St. Cyril of Alexandria", rank: "optional_memorial", color: "white" },
  "6-28": { name: "St. Irenaeus", rank: "memorial", color: "red" },
  "6-29": { name: "Sts. Peter and Paul, Apostles", rank: "solemnity", color: "red" },
  "6-30": { name: "First Martyrs of the Church of Rome", rank: "optional_memorial", color: "red" },
  // JULY
  "7-3":  { name: "St. Thomas the Apostle", rank: "feast", color: "red" },
  "7-5":  { name: "St. Anthony Mary Zaccaria", rank: "optional_memorial", color: "white" },
  "7-6":  { name: "St. Maria Goretti", rank: "optional_memorial", color: "red" },
  "7-9":  { name: "St. Augustine Zhao Rong and Companions", rank: "optional_memorial", color: "red" },
  "7-11": { name: "St. Benedict", rank: "memorial", color: "white" },
  "7-13": { name: "St. Henry", rank: "optional_memorial", color: "white" },
  "7-14": { name: "St. Kateri Tekakwitha", rank: "memorial", color: "white" },
  "7-15": { name: "St. Bonaventure", rank: "memorial", color: "white" },
  "7-16": { name: "Our Lady of Mount Carmel", rank: "optional_memorial", color: "white" },
  "7-20": { name: "St. Apollinaris", rank: "optional_memorial", color: "red" },
  "7-21": { name: "St. Lawrence of Brindisi", rank: "optional_memorial", color: "white" },
  "7-22": { name: "St. Mary Magdalene", rank: "feast", color: "white" },
  "7-23": { name: "St. Bridget of Sweden", rank: "optional_memorial", color: "white" },
  "7-24": { name: "St. Sharbel Makhluf", rank: "optional_memorial", color: "white" },
  "7-25": { name: "St. James the Apostle", rank: "feast", color: "red" },
  "7-26": { name: "Sts. Joachim and Anne", rank: "memorial", color: "white" },
  "7-29": { name: "Sts. Martha, Mary, and Lazarus", rank: "memorial", color: "white" },
  "7-30": { name: "St. Peter Chrysologus", rank: "optional_memorial", color: "white" },
  "7-31": { name: "St. Ignatius of Loyola", rank: "memorial", color: "white" },
  // AUGUST
  "8-1":  { name: "St. Alphonsus Liguori", rank: "memorial", color: "white" },
  "8-2":  { name: "St. Eusebius of Vercelli and St. Peter Julian Eymard", rank: "optional_memorial", color: "white" },
  "8-4":  { name: "St. John Vianney, Cure of Ars", rank: "memorial", color: "white" },
  "8-5":  { name: "Dedication of the Basilica of St. Mary Major", rank: "optional_memorial", color: "white" },
  "8-6":  { name: "Transfiguration of the Lord", rank: "feast", color: "white" },
  "8-7":  { name: "St. Sixtus II and Companions, and St. Cajetan", rank: "optional_memorial", color: "red" },
  "8-8":  { name: "St. Dominic", rank: "memorial", color: "white" },
  "8-9":  { name: "St. Teresa Benedicta of the Cross (Edith Stein)", rank: "optional_memorial", color: "red" },
  "8-10": { name: "St. Lawrence, Deacon and Martyr", rank: "feast", color: "red" },
  "8-11": { name: "St. Clare", rank: "memorial", color: "white" },
  "8-12": { name: "St. Jane Frances de Chantal", rank: "optional_memorial", color: "white" },
  "8-13": { name: "Sts. Pontian and Hippolytus", rank: "optional_memorial", color: "red" },
  "8-14": { name: "St. Maximilian Mary Kolbe", rank: "memorial", color: "red" },
  "8-15": { name: "Assumption of the Blessed Virgin Mary", rank: "solemnity", color: "white" },
  "8-16": { name: "St. Stephen of Hungary", rank: "optional_memorial", color: "white" },
  "8-19": { name: "St. John Eudes", rank: "optional_memorial", color: "white" },
  "8-20": { name: "St. Bernard of Clairvaux", rank: "memorial", color: "white" },
  "8-21": { name: "Pope St. Pius X", rank: "memorial", color: "white" },
  "8-22": { name: "Queenship of the Blessed Virgin Mary", rank: "memorial", color: "white" },
  "8-23": { name: "St. Rose of Lima", rank: "optional_memorial", color: "white" },
  "8-24": { name: "St. Bartholomew the Apostle", rank: "feast", color: "red" },
  "8-25": { name: "St. Louis and St. Joseph of Calasanz", rank: "optional_memorial", color: "white" },
  "8-27": { name: "St. Monica", rank: "memorial", color: "white" },
  "8-28": { name: "St. Augustine of Hippo", rank: "memorial", color: "white" },
  "8-29": { name: "Passion of St. John the Baptist", rank: "memorial", color: "red" },
  // SEPTEMBER
  "9-3":  { name: "St. Gregory the Great", rank: "memorial", color: "white" },
  "9-5":  { name: "St. Teresa of Calcutta", rank: "optional_memorial", color: "white" },
  "9-8":  { name: "Birth of the Blessed Virgin Mary", rank: "feast", color: "white" },
  "9-9":  { name: "St. Peter Claver", rank: "memorial", color: "white" },
  "9-12": { name: "Holy Name of the Blessed Virgin Mary", rank: "optional_memorial", color: "white" },
  ...
  "9-17": { name: "St. Robert Bellarmine and St. Hildegard of Bingen", rank: "optional_memorial", color: "white" },
  "9-19": { name: "St. Januarius", rank: "optional_memorial", color: "red" },
  "9-20": { name: "Sts. Andrew Kim Tae-gon, Paul Chong Ha-sang, and Companions", rank: "memorial", color: "red" },
  "9-21": { name: "St. Matthew the Apostle", rank: "feast", color: "red" },
  "9-23": { name: "St. Pio of Pietrelcina (Padre Pio)", rank: "memorial", color: "white" },
  "9-26": { name: "Sts. Cosmas and Damian", rank: "optional_memorial", color: "red" },
  "9-27": { name: "St. Vincent de Paul", rank: "memorial", color: "white" },
  "9-28": { name: "St. Wenceslaus and Sts. Lawrence Ruiz and Companions", rank: "optional_memorial", color: "red" },
  "9-29": { name: "Sts. Michael, Gabriel and Raphael, Archangels", rank: "feast", color: "white" },
  "9-30": { name: "St. Jerome", rank: "memorial", color: "white" },
  // OCTOBER
  "10-1": { name: "St. Therese of the Child Jesus", rank: "memorial", color: "white" },
  "10-2": { name: "Guardian Angels", rank: "memorial", color: "white" },
  "10-4": { name: "St. Francis of Assisi", rank: "memorial", color: "white" },
  "10-5": { name: "St. Faustina Kowalska", rank: "optional_memorial", color: "white" },
  "10-6": { name: "St. Bruno", rank: "optional_memorial", color: "white" },
  "10-7": { name: "Our Lady of the Rosary", rank: "memorial", color: "white" },
  "10-9": { name: "St. Denis and Companions, and St. John Leonardi", rank: "optional_memorial", color: "red" },
  "10-11": { name: "St. John XXIII", rank: "optional_memorial", color: "white" },
  "10-14": { name: "St. Callistus I", rank: "optional_memorial", color: "red" },
  "10-15": { name: "St. Teresa of Jesus (Avila)", rank: "memorial", color: "white" },
  "10-16": { name: "St. Hedwig and St. Margaret Mary Alacoque", rank: "optional_memorial", color: "white" },
  "10-17": { name: "St. Ignatius of Antioch", rank: "memorial", color: "red" },
  "10-18": { name: "St. Luke the Evangelist", rank: "feast", color: "red" },
  "10-19": { name: "Sts. Jean de Brebeuf, Isaac Jogues, and Companions", rank: "memorial", color: "red" },
  "10-20": { name: "St. Paul of the Cross", rank: "optional_memorial", color: "white" },
  "10-22": { name: "St. John Paul II", rank: "optional_memorial", color: "white" },
  "10-23": { name: "St. John of Capistrano", rank: "optional_memorial", color: "white" },
  "10-24": { name: "St. Anthony Mary Claret", rank: "optional_memorial", color: "white" },
  "10-28": { name: "Sts. Simon and Jude, Apostles", rank: "feast", color: "red" },
  // NOVEMBER
  "11-1": { name: "All Saints", rank: "solemnity", color: "white" },
  "11-2": { name: "All Souls", rank: "solemnity", color: "purple" },
  "11-3": { name: "St. Martin de Porres", rank: "optional_memorial", color: "white" },
  ...
  "11-13": { name: "St. Frances Xavier Cabrini", rank: "memorial", color: "white" },
  "11-15": { name: "St. Albert the Great", rank: "optional_memorial", color: "white" },
  "11-16": { name: "St. Margaret of Scotland and St. Gertrude the Great", rank: "optional_memorial", color: "white" },
  "11-17": { name: "St. Elizabeth of Hungary", rank: "memorial", color: "white" },
  "11-18": { name: "Dedication of Basilicas of Sts. Peter and Paul", rank: "optional_memorial", color: "white" },
  "11-21": { name: "Presentation of the Blessed Virgin Mary", rank: "memorial", color: "white" },
  "11-22": { name: "St. Cecilia", rank: "memorial", color: "red" },
  "11-23": { name: "St. Clement I, Blessed Miguel Pro, and St. Columban", rank: "optional_memorial", color: "white" },
  "11-24": { name: "St. Andrew Dung-Lac and Companions", rank: "memorial", color: "red" },
  "11-25": { name: "St. Catherine of Alexandria", rank: "optional_memorial", color: "red" },
  "11-30": { name: "St. Andrew the Apostle", rank: "feast", color: "red" },
  // DECEMBER
  "12-3": { name: "St. Francis Xavier", rank: "memorial", color: "white" },
  "12-4": { name: "St. John Damascene", rank: "optional_memorial", color: "white" },
  "12-6": { name: "St. Nicholas", rank: "optional_memorial", color: "white" },
  ...
  "12-9": { name: "St. Juan Diego", rank: "optional_memorial", color: "white" },
  "12-10": { name: "Our Lady of Loreto", rank: "optional_memorial", color: "white" },
  "12-11": { name: "St. Damasus I", rank: "optional_memorial", color: "white" },
  ...
  "12-21": { name: "St. Peter Canisius", rank: "optional_memorial", color: "white" },
  "12-23": { name: "St. John of Kanty", rank: "optional_memorial", color: "white" },
  "12-25": { name: "Nativity of the Lord", rank: "solemnity", color: "white" },
  "12-26": { name: "St. Stephen, First Martyr", rank: "feast", color: "red" },
  "12-27": { name: "St. John the Apostle and Evangelist", rank: "feast", color: "white" },
  "12-28": { name: "Holy Innocents, Martyrs", rank: "feast", color: "red" },
  "12-29": { name: "St. Thomas Becket", rank: "optional_memorial", color: "red" },
  "12-31": { name: "St. Sylvester I", rank: "optional_memorial", color: "white" },
};
...
const TLM_FIXED = {
  // JANUARY
  "1-1":  { name: "Octave of the Nativity of the Lord", rank: "class_1", color: "white" },
  "1-6":  { name: "Epiphany of the Lord", rank: "class_1", color: "white" },
  "1-13": { name: "Baptism of Our Lord Jesus Christ", rank: "class_2", color: "white" },
  "1-14": { name: "St. Hilary, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "1-15": { name: "St. Paul the First Hermit", rank: "class_3", color: "white" },
  "1-16": { name: "St. Marcellus I, Pope and Martyr", rank: "class_3", color: "red" },
  "1-17": { name: "St. Anthony, Abbot", rank: "class_3", color: "white" },
  "1-20": { name: "Sts. Fabian, Pope, and Sebastian, Martyrs", rank: "class_3", color: "red" },
  "1-21": { name: "St. Agnes, Virgin and Martyr", rank: "class_3", color: "red" },
  "1-22": { name: "Sts. Vincent and Anastasius, Martyrs", rank: "class_3", color: "red" },
  "1-23": { name: "St. Raymond of Penafort, Confessor", rank: "class_3", color: "white" },
  "1-24": { name: "St. Timothy, Bishop and Martyr", rank: "class_3", color: "red" },
  "1-25": { name: "Conversion of St. Paul, Apostle", rank: "class_3", color: "white" },
  "1-26": { name: "St. Polycarp, Bishop and Martyr", rank: "class_3", color: "red" },
  "1-27": { name: "St. John Chrysostom, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "1-29": { name: "St. Francis de Sales, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "1-31": { name: "St. John Bosco, Confessor", rank: "class_3", color: "white" },
  // FEBRUARY
  "2-2":  { name: "Purification of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "2-4":  { name: "St. Andrew Corsini, Bishop and Confessor", rank: "class_3", color: "white" },
  "2-5":  { name: "St. Agatha, Virgin and Martyr", rank: "class_3", color: "red" },
  "2-6":  { name: "St. Titus, Bishop and Confessor", rank: "class_3", color: "white" },
  "2-7":  { name: "St. Romuald, Abbot", rank: "class_3", color: "white" },
  "2-10": { name: "St. Scholastica, Virgin", rank: "class_3", color: "white" },
  "2-11": { name: "Apparition of the Blessed Virgin Mary Immaculate (Lourdes)", rank: "class_3", color: "white" },
  "2-12": { name: "Seven Holy Founders of the Servite Order", rank: "class_3", color: "white" },
  "2-22": { name: "Chair of St. Peter, Apostle", rank: "class_2", color: "white" },
  "2-23": { name: "St. Peter Damian, Confessor", rank: "class_3", color: "white" },
  "2-24": { name: "St. Matthias, Apostle", rank: "class_2", color: "red" },
  "2-27": { name: "St. Gabriel of Our Lady of Sorrows", rank: "class_3", color: "white" },
  // MARCH
  "3-4":  { name: "St. Casimir, Confessor", rank: "class_3", color: "white" },
  "3-6":  { name: "Sts. Perpetua and Felicity, Martyrs", rank: "class_3", color: "red" },
  "3-7":  { name: "St. Thomas Aquinas, Confessor and Doctor", rank: "class_3", color: "white" },
  "3-8":  { name: "St. John of God, Confessor", rank: "class_3", color: "white" },
  "3-9":  { name: "St. Frances of Rome, Widow", rank: "class_3", color: "white" },
  "3-10": { name: "The Forty Holy Martyrs", rank: "class_3", color: "red" },
  "3-12": { name: "St. Gregory the Great, Pope, Confessor and Doctor", rank: "class_3", color: "white" },
  "3-17": { name: "St. Patrick, Bishop and Confessor", rank: "class_3", color: "white" },
  "3-18": { name: "St. Cyril of Jerusalem, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "3-19": { name: "St. Joseph, Spouse of the Blessed Virgin Mary", rank: "class_1", color: "white" },
  "3-21": { name: "St. Benedict, Abbot", rank: "class_3", color: "white" },
  "3-24": { name: "St. Gabriel the Archangel", rank: "class_3", color: "white" },
  "3-25": { name: "Annunciation of the Blessed Virgin Mary", rank: "class_1", color: "white" },
  "3-27": { name: "St. John Damascene, Confessor and Doctor", rank: "class_3", color: "white" },
  "3-28": { name: "St. John of Capistrano, Confessor", rank: "class_3", color: "white" },
  // APRIL
  "4-2":  { name: "St. Francis of Paola, Confessor", rank: "class_3", color: "white" },
  "4-4":  { name: "St. Isidore, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "4-5":  { name: "St. Vincent Ferrer, Confessor", rank: "class_3", color: "white" },
  "4-11": { name: "St. Leo the Great, Pope, Confessor and Doctor", rank: "class_3", color: "white" },
  "4-13": { name: "St. Hermenegild, Martyr", rank: "class_3", color: "red" },
  "4-14": { name: "St. Justin, Martyr", rank: "class_3", color: "red" },
  "4-21": { name: "St. Anselm, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "4-22": { name: "Sts. Soter and Caius, Popes and Martyrs", rank: "class_3", color: "red" },
  "4-24": { name: "St. Fidelis of Sigmaringen, Martyr", rank: "class_3", color: "red" },
  "4-25": { name: "St. Mark, Evangelist", rank: "class_2", color: "red" },
  "4-26": { name: "Sts. Cletus and Marcellinus, Popes and Martyrs", rank: "class_3", color: "red" },
  "4-27": { name: "St. Peter Canisius, Confessor and Doctor", rank: "class_3", color: "white" },
  "4-28": { name: "St. Paul of the Cross, Confessor", rank: "class_3", color: "white" },
  "4-29": { name: "St. Peter Martyr", rank: "class_3", color: "red" },
  "4-30": { name: "St. Catherine of Siena, Virgin", rank: "class_3", color: "white" },
  // MAY
  "5-1":  { name: "St. Joseph the Worker, Spouse of the Blessed Virgin Mary", rank: "class_1", color: "white" },
  "5-2":  { name: "St. Athanasius, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "5-4":  { name: "St. Monica, Widow", rank: "class_3", color: "white" },
  "5-5":  { name: "St. Pius V, Pope and Confessor", rank: "class_3", color: "white" },
  "5-7":  { name: "St. Stanislaus, Bishop and Martyr", rank: "class_3", color: "red" },
  "5-9":  { name: "St. Gregory Nazianzen, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "5-10": { name: "St. Antoninus, Bishop and Confessor", rank: "class_3", color: "white" },
  "5-11": { name: "Sts. Philip and James, Apostles", rank: "class_2", color: "red" },
  "5-12": { name: "Sts. Nereus, Achilleus, Domitilla and Pancras, Martyrs", rank: "class_3", color: "red" },
  "5-13": { name: "St. Robert Bellarmine, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "5-15": { name: "St. John Baptist de la Salle, Confessor", rank: "class_3", color: "white" },
  "5-19": { name: "St. Peter Celestine, Pope and Confessor", rank: "class_3", color: "white" },
  "5-20": { name: "St. Bernardine of Siena, Confessor", rank: "class_3", color: "white" },
  "5-25": { name: "St. Gregory VII, Pope and Confessor", rank: "class_3", color: "white" },
  "5-26": { name: "St. Philip Neri, Confessor", rank: "class_3", color: "white" },
  "5-27": { name: "St. Bede the Venerable, Confessor and Doctor", rank: "class_3", color: "white" },
  "5-29": { name: "St. Mary Magdalen de Pazzi, Virgin", rank: "class_3", color: "white" },
  "5-31": { name: "Our Lady, Queen", rank: "class_2", color: "white" },
  // JUNE
  "6-1":  { name: "St. Angela Merici, Virgin", rank: "class_3", color: "white" },
  "6-4":  { name: "St. Francis Caracciolo, Confessor", rank: "class_3", color: "white" },
  "6-5":  { name: "St. Boniface, Bishop and Martyr", rank: "class_3", color: "red" },
  "6-6":  { name: "St. Norbert, Bishop and Confessor", rank: "class_3", color: "white" },
  "6-11": { name: "St. Barnabas, Apostle", rank: "class_3", color: "red" },
  "6-12": { name: "St. John of San Facundo, Confessor", rank: "class_3", color: "white" },
  "6-13": { name: "St. Anthony of Padua, Confessor", rank: "class_3", color: "white" },
  "6-14": { name: "St. Basil the Great, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "6-18": { name: "St. Ephrem the Syrian, Deacon, Confessor and Doctor", rank: "class_3", color: "white" },
  "6-19": { name: "St. Juliana Falconieri, Virgin", rank: "class_3", color: "white" },
  "6-21": { name: "St. Aloysius Gonzaga, Confessor", rank: "class_3", color: "white" },
  "6-22": { name: "St. Paulinus, Bishop and Confessor", rank: "class_3", color: "white" },
  "6-24": { name: "Nativity of St. John the Baptist", rank: "class_1", color: "white" },
  "6-26": { name: "Sts. John and Paul, Martyrs", rank: "class_3", color: "red" },
  "6-29": { name: "Sts. Peter and Paul, Apostles", rank: "class_1", color: "red" },
  "6-30": { name: "Commemoration of St. Paul, Apostle", rank: "class_3", color: "red" },
  // JULY
  "7-1":  { name: "Most Precious Blood of Our Lord Jesus Christ", rank: "class_1", color: "red" },
  "7-2":  { name: "Visitation of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "7-3":  { name: "St. Irenaeus, Bishop and Martyr", rank: "class_3", color: "red" },
  "7-5":  { name: "St. Anthony Mary Zaccaria, Confessor", rank: "class_3", color: "white" },
  "7-7":  { name: "Sts. Cyril and Methodius, Bishops and Confessors", rank: "class_3", color: "white" },
  "7-8":  { name: "St. Elizabeth, Queen and Widow", rank: "class_3", color: "white" },
  "7-12": { name: "St. John Gualbert, Abbot", rank: "class_3", color: "white" },
  "7-14": { name: "St. Bonaventure, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "7-15": { name: "St. Henry II, Emperor and Confessor", rank: "class_3", color: "white" },
  "7-18": { name: "St. Camillus de Lellis, Confessor", rank: "class_3", color: "white" },
  "7-19": { name: "St. Vincent de Paul, Confessor", rank: "class_3", color: "white" },
  "7-20": { name: "St. Jerome Emiliani, Confessor", rank: "class_3", color: "white" },
  "7-21": { name: "St. Lawrence of Brindisi, Confessor and Doctor", rank: "class_3", color: "white" },
  "7-22": { name: "St. Mary Magdalene, Penitent", rank: "class_3", color: "white" },
  "7-23": { name: "St. Apollinaris, Bishop and Martyr", rank: "class_3", color: "red" },
  "7-25": { name: "St. James, Apostle", rank: "class_2", color: "red" },
  "7-26": { name: "St. Anne, Mother of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "7-28": { name: "Sts. Nazarius, Celsus, Victor I and Innocent I", rank: "class_3", color: "red" },
  "7-29": { name: "St. Martha, Virgin", rank: "class_3", color: "white" },
  "7-31": { name: "St. Ignatius of Loyola, Confessor", rank: "class_3", color: "white" },
  // AUGUST
  "8-2":  { name: "St. Alphonsus Mary of Liguori, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "8-4":  { name: "St. Dominic, Confessor", rank: "class_3", color: "white" },
  "8-5":  { name: "Dedication of Our Lady of the Snows", rank: "class_3", color: "white" },
  "8-6":  { name: "Transfiguration of Our Lord Jesus Christ", rank: "class_2", color: "white" },
  "8-7":  { name: "St. Cajetan, Confessor", rank: "class_3", color: "white" },
  "8-8":  { name: "St. John Mary Vianney, Confessor and Priest", rank: "class_3", color: "white" },
  "8-10": { name: "St. Laurence, Deacon and Martyr", rank: "class_2", color: "red" },
  "8-12": { name: "St. Clare, Virgin", rank: "class_3", color: "white" },
  "8-15": { name: "Assumption of the Blessed Virgin Mary", rank: "class_1", color: "white" },
  "8-16": { name: "St. Joachim, Father of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "8-17": { name: "St. Hyacinth, Confessor", rank: "class_3", color: "white" },
  "8-19": { name: "St. John Eudes, Confessor", rank: "class_3", color: "white" },
  "8-20": { name: "St. Bernard, Abbot and Doctor", rank: "class_3", color: "white" },
  "8-21": { name: "St. Jane Frances de Chantal, Widow", rank: "class_3", color: "white" },
  "8-22": { name: "Immaculate Heart of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  ...
  "8-30": { name: "St. Rose of Lima, Virgin", rank: "class_3", color: "white" },
  "8-31": { name: "St. Raymond Nonnatus, Confessor", rank: "class_3", color: "white" },
  // SEPTEMBER
  "9-2":  { name: "St. Stephen, King and Confessor", rank: "class_3", color: "white" },
  "9-3":  { name: "Pope St. Pius X, Pope and Confessor", rank: "class_3", color: "white" },
  "9-5":  { name: "St. Laurence Justinian, Bishop and Confessor", rank: "class_3", color: "white" },
  "9-8":  { name: "Nativity of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "9-10": { name: "St. Nicholas of Tolentino, Confessor", rank: "class_3", color: "white" },
  "9-12": { name: "Most Holy Name of Mary", rank: "class_3", color: "white" },
  "9-14": { name: "Exaltation of the Holy Cross", rank: "class_2", color: "red" },
  "9-15": { name: "Seven Sorrows of the Blessed Virgin Mary", rank: "class_2", color: "purple" },
  "9-16": { name: "Sts. Cornelius, Pope, and Cyprian, Bishop, Martyrs", rank: "class_3", color: "red" },
  "9-18": { name: "St. Joseph of Cupertino, Confessor", rank: "class_3", color: "white" },
  "9-19": { name: "St. Januarius, Bishop and Companions, Martyrs", rank: "class_3", color: "red" },
  "9-21": { name: "St. Matthew, Apostle and Evangelist", rank: "class_2", color: "red" },
  "9-22": { name: "St. Thomas of Villanova, Bishop and Confessor", rank: "class_3", color: "white" },
  "9-23": { name: "St. Linus, Pope and Martyr", rank: "class_3", color: "red" },
  "9-27": { name: "Sts. Cosmas and Damian, Martyrs", rank: "class_3", color: "red" },
  "9-28": { name: "St. Wenceslaus, Duke and Martyr", rank: "class_3", color: "red" },
  "9-29": { name: "Dedication of St. Michael the Archangel", rank: "class_1", color: "white" },
  "9-30": { name: "St. Jerome, Priest, Confessor and Doctor", rank: "class_3", color: "white" },
  // OCTOBER
  "10-2": { name: "Holy Guardian Angels", rank: "class_3", color: "white" },
  "10-3": { name: "St. Teresa of the Child Jesus, Virgin", rank: "class_3", color: "white" },
  "10-4": { name: "St. Francis of Assisi, Confessor", rank: "class_3", color: "white" },
  "10-6": { name: "St. Bruno, Confessor", rank: "class_3", color: "white" },
  "10-7": { name: "Our Lady of the Rosary", rank: "class_2", color: "white" },
  "10-8": { name: "St. Bridget, Widow", rank: "class_3", color: "white" },
  "10-9": { name: "St. John Leonardi, Confessor", rank: "class_3", color: "white" },
  "10-10": { name: "St. Francis Borgia, Confessor", rank: "class_3", color: "white" },
  "10-11": { name: "Maternity of the Blessed Virgin Mary", rank: "class_2", color: "white" },
  "10-13": { name: "St. Edward, King and Confessor", rank: "class_3", color: "white" },
  "10-14": { name: "St. Callistus I, Pope and Martyr", rank: "class_3", color: "red" },
  "10-15": { name: "St. Teresa, Virgin", rank: "class_3", color: "white" },
  "10-16": { name: "St. Hedwig, Widow", rank: "class_3", color: "white" },
  "10-17": { name: "St. Margaret Mary Alacoque, Virgin", rank: "class_3", color: "white" },
  "10-18": { name: "St. Luke, Evangelist", rank: "class_2", color: "red" },
  "10-19": { name: "St. Peter of Alcantara, Confessor", rank: "class_3", color: "white" },
  "10-20": { name: "St. John of Kanty, Confessor", rank: "class_3", color: "white" },
  "10-23": { name: "St. Anthony Mary Claret, Bishop and Confessor", rank: "class_3", color: "white" },
  "10-24": { name: "St. Raphael the Archangel", rank: "class_3", color: "white" },
  "10-28": { name: "Sts. Simon and Jude, Apostles", rank: "class_2", color: "red" },
  // NOVEMBER
  "11-1": { name: "All Saints", rank: "class_1", color: "white" },
  "11-2": { name: "Commemoration of All the Faithful Departed", rank: "class_1", color: "purple" },
  "11-4": { name: "St. Charles, Bishop and Confessor", rank: "class_3", color: "white" },
  "11-9": { name: "Dedication of the Archbasilica of the Most Holy Saviour", rank: "class_2", color: "white" },
  "11-10": { name: "St. Andrew Avellino, Confessor", rank: "class_3", color: "white" },
  "11-11": { name: "St. Martin, Bishop and Confessor", rank: "class_3", color: "white" },
  "11-12": { name: "St. Martin I, Pope and Martyr", rank: "class_3", color: "red" },
  "11-13": { name: "St. Didacus, Confessor", rank: "class_3", color: "white" },
  "11-14": { name: "St. Josaphat, Bishop and Martyr", rank: "class_3", color: "red" },
  "11-15": { name: "St. Albert the Great, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "11-16": { name: "St. Gertrude, Virgin", rank: "class_3", color: "white" },
  "11-17": { name: "St. Gregory Thaumaturgus, Bishop and Confessor", rank: "class_3", color: "white" },
  "11-18": { name: "Dedication of the Basilicas of Sts. Peter and Paul", rank: "class_3", color: "white" },
  "11-19": { name: "St. Elizabeth, Widow", rank: "class_3", color: "white" },
  "11-20": { name: "St. Felix of Valois, Confessor", rank: "class_3", color: "white" },
  "11-21": { name: "Presentation of the Blessed Virgin Mary", rank: "class_3", color: "white" },
  "11-22": { name: "St. Cecilia, Virgin and Martyr", rank: "class_3", color: "red" },
  "11-23": { name: "St. Clement I, Pope and Martyr", rank: "class_3", color: "red" },
  "11-24": { name: "St. John of the Cross, Confessor and Doctor", rank: "class_3", color: "white" },
  "11-25": { name: "St. Catherine, Virgin and Martyr", rank: "class_3", color: "red" },
  "11-26": { name: "St. Sylvester, Abbot", rank: "class_3", color: "white" },
  "11-30": { name: "St. Andrew, Apostle", rank: "class_2", color: "red" },
  // DECEMBER
  "12-2": { name: "St. Bibiana, Virgin and Martyr", rank: "class_3", color: "red" },
  "12-3": { name: "St. Francis Xavier, Confessor", rank: "class_3", color: "white" },
  "12-4": { name: "St. Peter Chrysologus, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "12-6": { name: "St. Nicholas, Bishop and Confessor", rank: "class_3", color: "white" },
  "12-7": { name: "St. Ambrose, Bishop, Confessor and Doctor", rank: "class_3", color: "white" },
  "12-8": { name: "Immaculate Conception of the Blessed Virgin Mary", rank: "class_1", color: "white" },
  "12-11": { name: "St. Damasus I, Pope and Confessor", rank: "class_3", color: "white" },
  "12-13": { name: "St. Lucy, Virgin and Martyr", rank: "class_3", color: "red" },
  "12-16": { name: "St. Eusebius, Bishop and Martyr", rank: "class_3", color: "red" },
  "12-21": { name: "St. Thomas, Apostle", rank: "class_2", color: "red" },
  "12-25": { name: "Nativity of Our Lord Jesus Christ", rank: "class_1", color: "white" },
  "12-26": { name: "St. Stephen, Protomartyr", rank: "class_2", color: "red" },
  "12-27": { name: "St. John, Apostle and Evangelist", rank: "class_2", color: "white" },
  "12-28": { name: "Holy Innocents", rank: "class_2", color: "red" },
};
...
const TLM_RANK_LABELS = {
  ...
  double_1: "I Class",
  double_2: "II Class",
  double_greater: "II Class",
  double: "III Class",
  semidouble: "III Class",
  simple: "IV Class",
};
